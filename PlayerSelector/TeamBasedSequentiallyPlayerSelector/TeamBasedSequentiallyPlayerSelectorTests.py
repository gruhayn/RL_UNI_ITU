...
class MyTestCase(unittest.TestCase):
    ...
    def test_getNextPlayerMultiple(self):
        players1 = [Player("11"), Player("12"), Player("13")]
        ...
        self.assertEqual(selectedPlayer.get_name(), Player("11").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("21").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("31").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("12").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("22").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("32").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("13").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("21").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("33").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("11").get_name())
        selectedPlayer = player_selector.select_next_player()
        self.assertEqual(selectedPlayer.get_name(), Player("22").get_name())
    ...
    def test_getNextPlayerMultiple2(self):
